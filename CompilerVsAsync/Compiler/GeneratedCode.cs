...
namespace CompilerVsAsync.Compiler;
...
public class BlogService
{
    ...
    {
        public int State;
        public AsyncTaskMethodBuilder<PostByCompiler> Builder;
        public int PostId;
            ...
            try
            {
                ...
                IL_00b6:
                    try
                    {
                        ...
                        result = JsonSerializer.Deserialize<PostByCompiler>(awaiter2.GetResult());
                    }
                    finally
                    {
    ...
    public Task<PostByCompiler> ObterPostPorIdAsync(int postId)
    {
        var stateMachine = default(ObterPostPorIdAsyncStateMachine);
        stateMachine.Builder = AsyncTaskMethodBuilder<PostByCompiler>.Create();
